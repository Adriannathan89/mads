...
The promotion evidence must include complete Linux verification, the
PostgreSQL 16 service suites, Rust 1.85 checks, the workspace line coverage
threshold of 85%, and clean `cargo package --locked --workspace` archives.
macOS and Windows are outside the v0.7 release gate. Publishing, tagging, and
